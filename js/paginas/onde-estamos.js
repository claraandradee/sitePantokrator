// ==========================================================================
// ONDE ESTAMOS - troca o título, o texto, a imagem e os dados de contato
// da missão ao clicar nas setas
// ==========================================================================
document.addEventListener('DOMContentLoaded', function () {
  ...
  const imagemEl = document.getElementById('missaoImagem');
  ...
  // Campos opcionais (localizacao, endereco, mapa, email, telefone):
  // se deixar em branco ('') a linha correspondente simplesmente não aparece.
  const missoes = [
    {
      titulo: 'Sede Fundacional',
      imagem: '../img/foto-sede.png',
    ...
    },
    {
      ...
      imagem: '../img/foto-missao-sjc.png',
    ...
    },
    {
      ...
      imagem: '../img/foto-missao-santos.png',
    ...
    },
    {
      ...
      imagem: '../img/foto-missao-amp.png',
  ...
  function mostrar(novoIndice) {
    ...
    setTimeout(function () {
      ...
      if (imagemEl && missao.imagem) {
        imagemEl.src = missao.imagem;
        imagemEl.alt = missao.titulo;
      }
  ...
  if (imagemEl && missoes[0].imagem) {
    imagemEl.src = missoes[0].imagem;
    imagemEl.alt = missoes[0].titulo;
  }
});